...
import 'chatting_model.dart';
export 'chatting_model.dart';
...
class _ChattingWidgetState extends State<ChattingWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChattingModel());
                ...
                child: Align(
                  ...
                  child: FutureBuilder<ApiCallResponse>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final listViewMessagesResponse = snapshot.data!;
                      return Builder(
                        builder: (context) {
                          final messages = MessagesCall.message(
                                listViewMessagesResponse.jsonBody,
                              )?.toList() ??
                              [];
                          if (messages.isEmpty) {
                                    ...
                                    child: SafeArea(
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          color: (MessagesCall.sender(
                                                    listViewMessagesResponse
                                                        .jsonBody,
                                                  )?[messagesIndex]) ==
                                                  'Teacher'
